...
- Note: tangling should be performed _AFTER_ use-package is installed
...
#+BEGIN_SRC emacs-lisp :noweb tangle
  ...
  (use-package helm
    ...
    (helm-mode t)
    ;; (message "[krista] Loading helm-behavior...")
    <<helm-behavior>>
    ;; (message "[krista] Loading helm-recentf...")
    <<helm-recentf>>
    ;; (message "[krista] Loading helm-window-choices...")
    <<helm-window-choices>>
    :bind 
    <<helm-replace-defaults>>
    ;; I know that having a paren on its own line is bad style. But it's
    ;; necessary to have the org-tangle reference on its own line.
    )
#+END_SRC
*** Helm behavior
...
;; Don't let helm hijack your window!
