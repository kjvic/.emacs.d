...
(bind-key "H-S" #'krista/speedy-open-someday-maybe-file)
...
(if krista/packing-mode
  ...
  (setq org-todo-keywords
        (quote ((sequence "TODO(t)" "PROJECT(p)" "NEXT(n)" "BLOCKED(b)" "WAITING(w)" "|" "CANCELLED(c)" "DONE(d)")
		))))
...
(setq org-agenda-sorting-strategy
      '((agenda habit-down priority-down tag-up effort-down category-up time-up deadline-up scheduled-up)
        (todo habit-down priority-down tag-up effort-down category-up time-up deadline-up scheduled-up)))
