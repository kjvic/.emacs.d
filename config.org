...
#+END_SRC
*** Hints
**** C-c p s s :: Projectile - search - silver searcher
**** C-c p r :: souped-up find-replace
**** C-c p f :: souped-up file-find
**** C-c p k :: kill buffers within the project
**** C-c p a :: switch to related file
***** e.g. if you're in Collection.c, C-c p a will switch to Collection.h
* Magit
