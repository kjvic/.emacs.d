...
(bind-key "H-m" #'rename-file) ;; H-m is for "mv"
...
(setq org-capture-templates
      '(("a" "annoy" entry
        ...
        ("u" "how to deal with umich" entry
         (file+olp "~/core/lists/advice.org" "how to deal with umich")
         "* %?\n %i\n")
        ("v" "advice" entry
...
(setq krista/recentf-save-interval 30000)
