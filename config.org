...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Stop bumping into the end of the modeline!
  ;; Thanks to http://ergoemacs.org/emacs/emacs_stop_cursor_enter_prompt.html
  (customize-set-variable
   'minibuffer-prompt-properties
   (quote (read-only t cursor-intangible t face minibuffer-prompt)))

  ;; Referrer: https://emacs.stackexchange.com/questions/368/how-do-i-make-org-beginning-of-line-move-cursor-to-the-first-text-in-heading-b
  ;;
...
#+END_SRC
** TODO get an *X* when the buffer is modified
* Helm
** Introduction
