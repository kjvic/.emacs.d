...
(defun krista/speedy-open-media-file ()
  (interactive) (find-file krista/media-file))
...
;; Options for org-refile. limiting level to 3 for performance reasons.
...
(setq org-agenda-sorting-strategy
      '((agenda tag-up effort-down category-up priority-down time-up deadline-up scheduled-up)
        (todo tag-up category-up priority-down)))
